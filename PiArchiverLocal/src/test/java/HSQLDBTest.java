...
public class HSQLDBTest {
    public static void main(String[] args) throws
        ...
        try {
            ...
            hsqlServer.setDatabasePath(0, "file:C:\\Users\\phan\\AppData\\Roaming\\piarchiver\\test\\testdb");
            ...
            try {
                ...
                connection = DriverManager.getConnection(
                        "jdbc:hsqldb:hsql://localhost/xdb", "sa", "");//use localhost cause of  hsqlServer.start();
                ...
                // with SELECT query.
              /*  connection.prepareStatement("drop table testtable if exists")
                        .execute();
